...
const FUNCTIES = [
  {
    icoon: "navigation" as const,
    titel: "Straatniveau autocomplete",
    tekst: "Typ een adres met huisnummer en ontvang directe suggesties via Google Maps.",
  },
  {
    icoon: "credit-card" as const,
    titel: "Wettelijke tarieven 2026",
    tekst: "Berekend op basis van de officieel vastgestelde maximumtarieven van de overheid.",
  },
  {
    icoon: "users" as const,
    titel: "Auto & Taxibusje",
    tekst: "Ondersteunt personenauto (max. 4 pers.) en taxibusje (5-8 pers.).",
  },
  {
    icoon: "globe" as const,
    titel: "Internationale ritten",
    tekst: "Voeg tolkosten, grenstoeslagen en andere extra's toe aan uw berekening.",
  },
  {
    icoon: "clock" as const,
    titel: "Ritgeschiedenis",
    tekst: "Bewaar en deel uitgevoerde berekeningen, inclusief volledige prijsopbouw.",
  },
  {
    icoon: "wifi-off" as const,
    titel: "Offline modus",
    tekst: "Werkt volledig zonder internet via handmatige km- en tijdinvoer.",
  },
];
      ...
      >
        ...
        <View style={styles.hero}>
          <View style={[styles.logoBadge, { backgroundColor: colors.primary }]}>
            <Feather name="navigation" size={32} color="#000" />
          </View>
          <Text style={[styles.appNaam, { color: colors.primary }]}>
            Taximeter Pro
          </Text>
        ...
        <TouchableOpacity
          onPress={openApp}
          activeOpacity={0.85}
          style={[styles.openKnop, { backgroundColor: colors.primary }]}
        >
        ...
        <View style={styles.badgesRij}>
          ...
          >
            <Feather name="tablet" size={18} color={colors.foreground} />
            <View>
        ...
        {/* Functies grid */}
        <Text style={[styles.sectionKop, { color: colors.foreground }]}>
          Waarom Taximeter Pro?
        </Text>
        <View style={styles.functiesGrid}>
          {FUNCTIES.map((f, idx) => (
            <View
              key={idx}
              style={[styles.functieKaart, { backgroundColor: colors.card, borderColor: colors.border }]}
            >
              <View style={[styles.functieIcon, { backgroundColor: colors.primary + "22" }]}>
                <Feather name={f.icoon} size={20} color={colors.primary} />
              </View>
...
const styles = StyleSheet.create({
  ...
  footerDisclaimer: {
    ...
    textAlign: "center", lineHeight: 16, maxWidth: 360,
  },
});
